$(document).ready(function () {
   ...
   var projectArr =
      ...
      href: "https://digital-menu-project.herokuapp.com/ target='_blank'",
      url: "./images/druid.png",
      ...
      id: "the burger joint",
      href: "https://morning-savannah-57705.herokuapp.com/ target='_blank'",
      url: "./images/the_burger_joint.png",
      title: "The Burger Joint",
      about: "Application that uses Node.js, MySQL..."
   },{
      id: "crazy team",
      href: "https://vjeuel.github.io/TeamProfileGenerator/Develop/output/team.html target='_blank'",
      url: "./images/crazy_team.png",
   ...
   for (let i = 0; i < projectArr.length; i++) {  
      ...
      <div class='project-box'>
         <a href=${projectArr[i].href}>
         <img style="background-image:url(${projectArr[i].url})">
         <h3>${projectArr[i].title}</h3>
         <h4>${projectArr[i].about}</h4>
         `;
